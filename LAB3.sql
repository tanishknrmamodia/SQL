...
INSERT INTO EMPLOYEE VALUES ("2330349","KATA","KAP","CLERK","2330349","2020-08-01",95000,15000,"55005","SBDG5543");

SELECT * FROM EMPLOYEE;

SELECT CONCAT(Lname,",",Fname) AS EmployeeName, Salary FROM EMPLOYEE;
...
SELECT * FROM TERM;
SELECT * FROM TERM WHERE TermDesc = "SPRING";
...
SELECT * FROM FACULTY;
SELECT NAME FROM FACULTY WHERE DeptId IN ("123ER","123TY");
...
SELECT * FROM STUDENT;
SELECT * FROM STUDENT WHERE STATE IN ("ASSAM","BIHAR");

SET SQL_SAFE_UPDATES=0;
UPDATE EMPLOYEE SET Salary=1.11*Salary WHERE EmployeeId = 111;
SELECT * FROM EMPLOYEE;
...
DELETE FROM DEPARTMENT WHERE DeptId = "110001"; 
...
ALTER TABLE TERM ADD COLUMN newTERM VARCHAR(50); 
SELECT * FROM TERM;
...
SELECT * FROM STUDENT WHERE StartTerm LIKE '4th Year%';
